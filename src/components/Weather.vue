    ...
    <div class="weather">
        ...
        <div class="weather__main">
            <div class="weather__search">
                <input type="text" v-on:keyup.enter="fetchData"  v-model="textInput" placeholder="Enter name of city ex: Ho Chi Minh,...">
                <button :class="[textInput ? 'active' : '']" :disabled="!textInput" @click="fetchData">Search</button>
            </div>
...
export default {
    ...
    methods: {
        fetchData: async function(){
            ...
            this.loading = true;
            try{
                let res = await axios.get(API_SEARCH + this.textInput)
                this.data = {
